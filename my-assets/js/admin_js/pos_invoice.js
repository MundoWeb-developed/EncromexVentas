      ...
      $("#addinvoice tbody tr").remove();
       ...
       if(data.quote)
        ...
        }else
        {
            ...
            window.open('invoice_details_cs/'+data.invoice_id, '_blank');
            window.open('invoice_details_del/'+data.invoice_id, '_blank');
        }
	...
	function render_pos_inv(x) {
		...
		if(x==1){
			...
			elems.forEach(function(word) {
				...
				html_render_entrega +='<div class="row" style="border-bottom:1px solid #666;">'+
										'<div class="col-md-7">'+
											'<div class="row">'+
												'<p>Complete los siguientes campos:</p>'+
												'<div class="col-md-2"  style="margin-bottom:5px;">'+
													'<input id="id_arreglo_'+word.id+'" type="text" class="form-control" name="id_arreglo[]" placeholder="ID Arreglo" value="'+word.id+'"  readonly>'+
												'</div>	'+					
												'<div class="col-md-3"  style="margin-bottom:5px;">'+
													'<input id="arreglo_'+word.id+'" type="text" class="form-control" name="arreglo[]" placeholder="Nombre del arreglo" value="'+word.nombre+'" readonly>'+
												'</div>'+
												'<div class="col-md-3" style="margin-bottom:5px;">'+
													'<input type="text" class="form-control fecha_entrega" id="fecha_entrega_'+word.id+'" name="fecha_entrega[]" placeholder="Fecha de entrega" ida="'+word.id+'">'+
													'<script>$(function() {$("#fecha_entrega_'+word.id+'").daterangepicker({timePicker: true,singleDatePicker: true,locale: {format: "YYYY-MM-DD HH:mm", applyLabel: "Guardar",cancelLabel: "Cancelar",daysOfWeek: ["Do","Lu","Ma","Mi","Ju","Vi","Sa"],monthNames: ["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"]}});});</script>'+
												'</div>'+					
												'<div class="col-md-4" style="margin-bottom:5px;">'+
													'<select id="hora_entrega_'+word.id+'" class="hora_entrega" name="hora_entrega[]" style="padding-top:5px;padding-bottom:5px;" ida="'+word.id+'">'+
												...
												'<div class="col-md-12"  style="margin-bottom:5px;">'+
													'<input id="destinatario_'+word.id+'" type="text" class="form-control destinatario" name="destinatario[]" placeholder="Nombre del destinatario" ida="'+word.id+'">'+
												'</div>'+
												'<div class="col-md-12"  style="margin-bottom:5px;">'+
													'<input type="text" class="form-control autocomplete direccion" id="direccion_'+word.id+'" name="direccion[]" placeholder="Dirección" ida="'+word.id+'">'+
													'<input type="hidden" id="lat_'+word.id+'" name="lat[]">'+
													'<input type="hidden" id="lon_'+word.id+'" name="lon[]">'+
													'<input type="hidden" id="radius_'+word.id+'" name="radius[]">'+
												'</div>'+
												'<div class="col-md-8" style="margin-bottom:5px;">'+
													'<input id="direccion2_'+word.id+'" type="text" class="form-control direccion2" name="direccion2[]" placeholder="Dirección 2" ida="'+word.id+'">'+
												'</div>'+
					
												'<div class="col-md-4"  style="margin-bottom:5px;">'+
													'<select id="zona_'+word.id+'" name="zona[]" style="padding-top:5px;padding-bottom:5px;">'+optz+'</select>'+
												'</div>'+				
					
												'<div class="col-md-12" style="margin-bottom:5px;">'+
													'<input id="descripcion_entrega_'+word.id+'" type="text" class="form-control descripcion_entrega" name="descripcion_entrega[]" placeholder="Anotaciones de entrega/Referencias" ida="'+word.id+'">'+
												'</div>'+
					
					
												'<div class="col-md-12" style="margin-bottom:5px;">'+
													'<input id="telefono_'+word.id+'" type="text" class="form-control phone" name="telefono[]" placeholder="Teléfono">'+
												'</div>'+
												'<p>Datos del cliente:</p>'+
												'<div class="col-md-6"  style="margin-bottom:5px;">'+
													'<input id="nombre_cliente_'+word.id+'" type="text" class="form-control" name="nombre_cliente[]" placeholder="Nombre del cliente">'+
												'</div>'+
												'<div class="col-md-6" style="margin-bottom:5px;">'+
													'<input id="telefono_cliente_'+word.id+'" type="text" class="form-control phone" name="telefono_cliente[]" placeholder="Teléfono de cliente">'+
												'</div>'+					
											'</div>'+
										'</div>'+
										'<div class="col-md-5">'+
											'<div id="us2_'+word.id+'" style="width:100%; height:220px;"></div>'+
										'</div>'+										
										'<script>$("#us2_'+word.id+'").locationpicker({location: {latitude: 17.067100,longitude: -96.720410},radius: 300,inputBinding: {latitudeInput: $("#lat_'+word.id+'"),longitudeInput: $("#lon_'+word.id+'"),radiusInput: $("#radius_'+word.id+'"),locationNameInput: $("#direccion_'+word.id+'")},enableAutocomplete: true});$(".phone").mask("(000) 000-0000");</script>'+
									'</div>';
				
				
				html_render_reparto+= '<div class="row" style="border-bottom:1px solid #666;">'+
					
										'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">ID Arreglo</label>'+
											'<input type="text" class="form-control" name="id_arreglo_reparto[]" placeholder="ID Arreglo" value="'+word.id+'"  readonly>'+
										'</div>	'+					
										'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">Nombre Arreglo</label>'+
											'<input type="text" class="form-control" name="arreglo_reparto[]" placeholder="Nombre del arreglo" value="'+word.nombre+'" readonly>'+
										'</div>'+
									'<div class="col-md-6"  style="margin-bottom:5px;">'+
										'<label for="destinatario_reparto_'+word.id+'" class="form-label">Nombre del destinatario</label>'+
										'<input type="text" class="form-control" id="destinatario_reparto_'+word.id+'" name="destinatario_reparto[]" placeholder="Nombre del destinatario" readonly>'+
									'</div>'+	
					
									'<div class="col-md-6"  style="margin-bottom:5px;">'+
										'<label for="direccion_reparto_'+word.id+'" class="form-label">Dirección de entrega</label>'+
										'<input type="text" class="form-control autocomplete" id="direccion_reparto_'+word.id+'" name="direccion_reparto[]" placeholder="Dirección" readonly>'+
									'</div>'+
									'<div class="col-md-3" style="margin-bottom:5px;">'+
										'<label for="fecha_entrega_reparto_'+word.id+'" class="form-label">Fecha de entrega</label>'+
										'<input type="text" class="form-control" id="fecha_entrega_reparto_'+word.id+'" name="fecha_entrega_reparto[]" placeholder="Fecha de entrega" readonly>'+
									'</div>'+
									'<div class="col-md-3" style="margin-bottom:5px;">'+
										'<label for="hora_entrega_reparto_'+word.id+'" class="form-label">Hora de entrega</label>'+
										'<input type="text" class="form-control" id="hora_entrega_reparto_'+word.id+'" name="hora_entrega_reparto[]" readonly  value="6:00 am - 8:00 am">'+
									'</div>'+
					
									'<div class="col-md-12" style="margin-bottom:5px;">'+
										'<label for="descripcion_entrega_reparto_'+word.id+'" class="form-label">Anotaciones de entrega/Referencias</label>'+
										'<input type="text" class="form-control" id="descripcion_entrega_reparto_'+word.id+'" name="descripcion_entrega_reparto[]" placeholder="Anotaciones de entrega/Referencias" readonly>'+
									'</div>'+
								'</div>';
				
				html_render_caja+= '<div class="row" style="border-bottom:1px solid #666;">'+
					
										'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">ID Arreglo</label>'+
											'<input type="text" class="form-control" name="id_arreglo_caja[]" placeholder="ID Arreglo" value="'+word.id+'"  readonly>'+
										'</div>	'+					
										'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">Nombre Arreglo</label>'+
											'<input type="text" class="form-control" name="arreglo_caja[]" placeholder="Nombre del arreglo" value="'+word.nombre+'" readonly>'+
										'</div>'+
					
					
					
									'<div class="col-md-6"  style="margin-bottom:5px;">'+
									'<label for="cliente_caja_'+word.id+'" class="form-label">Nombre del cliente</label>'+
									'<input type="text" class="form-control customer_name" id="cliente_caja_'+word.id+'" name="cliente_caja[]" placeholder="Nombre del cliente" readonly value="'+customer_name+'">'+
									'</div>'+
					
									'<div class="col-md-3" style="margin-bottom:5px;">'+
									'<label for="fecha_entrega_caja_'+word.id+'" class="form-label">Fecha de entrega</label>'+
									'<input type="text" class="form-control" id="fecha_entrega_caja_'+word.id+'" name="fecha_entrega_caja[]" placeholder="Fecha de entrega" readonly>'+
									'</div>'+
									'<div class="col-md-3" style="margin-bottom:5px;">'+
										'<label for="hora_entrega_caja_'+word.id+'" class="form-label">Hora de entrega</label>'+
										'<input type="text" class="form-control" id="hora_entrega_caja_'+word.id+'" name="hora_entrega_caja[]"  readonly  value="6:00 am - 8:00 am">'+
									'</div>'+
									'<div class="col-md-6"  style="margin-bottom:5px;">'+
									'<label for="destinatario_caja_'+word.id+'" class="form-label">Nombre del destinatario</label>'+
									'<input type="text" class="form-control" id="destinatario_caja_'+word.id+'" name="destinatario_caja[]" placeholder="Nombre del destinatario" readonly>'+
									'</div>'+
					
					
									'<div class="col-md-6"  style="margin-bottom:5px;">'+
									'<label for="direccion_caja_'+word.id+'" class="form-label">Dirección de entrega</label>'+
									'<input type="text" class="form-control autocomplete" id="direccion_caja_'+word.id+'" name="direccion_caja[]" placeholder="Dirección" readonly>'+
									'</div>'+
									'<div class="col-md-6" style="margin-bottom:5px;">'+
									'<label for="repartidor_caja_'+word.id+'" class="form-label">Repartidor:</label><br>'+
									'<select style="padding-top:5px;padding-bottom:5px;" id="repartidor_caja_'+word.id+'" name="repartidor_caja[]" >'+opts+'</select>'+
									'</div>'+
					
									'<div class="col-md-12" style="margin-bottom:5px;">'+
									'<label for="descripcion_entrega_caja_'+word.id+'" class="form-label">Anotaciones de entrega/Referencias</label>'+
									'<input type="text" class="form-control" id="descripcion_entrega_caja_'+word.id+'" name="descripcion_entrega_caja[]" placeholder="Anotaciones de entrega/Referencias" readonly>'+
									'</div>'+
				...
				html_render_taller+= '<div class="row" style="border-bottom:1px solid #666;">'+
					
					'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">ID Arreglo</label>'+
											'<input type="text" class="form-control" name="id_arreglo_taller[]" placeholder="ID Arreglo" value="'+word.id+'"  readonly>'+
										'</div>	'+					
										'<div class="col-md-3"  style="margin-bottom:5px;">'+
					'<label class="form-label">Nombre Arreglo</label>'+
											'<input type="text" class="form-control" name="arreglo_taller[]" placeholder="Nombre del arreglo" value="'+word.nombre+'" readonly>'+
										'</div>'+
					
								'<div class="col-md-3" style="margin-bottom:5px;">'+
									'<label for="fecha_entrega_taller_'+word.id+'" class="form-label">Fecha de entrega</label>'+
									'<input type="text" class="form-control" id="fecha_entrega_taller_'+word.id+'" name="fecha_entrega_taller[]" placeholder="Fecha de entrega"  readonly>'+
								'</div>'+
								'<div class="col-md-3" style="margin-bottom:5px;">'+
									'<label for="hora_entrega_taller_'+word.id+'" class="form-label">Hora de entrega</label>'+
									'<input type="text" class="form-control" id="hora_entrega_taller_'+word.id+'" name="hora_entrega_taller[]"  readonly  value="6:00 am - 8:00 am">'+
								'</div>'+
								'<div class="col-md-12"  style="margin-bottom:5px;">'+
									'<label for="florista_taller_'+word.id+'" class="form-label">Florísta</label><br>'+
									'<select style="padding-top:5px;padding-bottom:5px;" id="florista_taller_'+word.id+'" name="florista_taller[]" placeholder="Florísta">'+optfl+'</select>'+
								'</div>'+
								'<p>Detalles de materiales</p>'+
					
								'<div class="col-md-12"  style="margin-bottom:5px;">'+
									'<table id="insumos_arreglo_'+word.id+'"class="table"><thead><th>Producto</th><th>Cantidad</th><!--<th>Precio</th><th>Total</th>--></thead><tbody>'+_details_+'</tbody></table>'+
								'</div>'+
					
					
								'<div class="col-md-3"  style="margin-bottom:5px; display:none;">'+
									'<label for="cantidad_modelo_'+word.id+'" class="form-label">Cantidad</label>'+
									'<input type="text" class="form-control" id="cantidad_modelo_'+word.id+'" name="cantidad_modelo[]" placeholder="Cantidad">'+
								'</div>'+
								'<div class="col-md-9"  style="margin-bottom:5px; display:none;">'+
									'<label for="modelo_'+word.id+'" class="form-label">Modelo</label>'+
									'<input type="text" class="form-control" id="modelo_'+word.id+'" name="modelo[]" placeholder="Modelo">'+
								'</div>'+
								'<div class="col-md-3"  style="margin-bottom:5px; display:none;">'+
									'<label for="cantidad_bases_'+word.id+'" class="form-label">Cantidad</label>'+
									'<input type="text" class="form-control" id="cantidad_bases_'+word.id+'" name="cantidad_bases[]" placeholder="Cantidad">'+
								'</div>'+
								'<div class="col-md-9"  style="margin-bottom:5px; display:none;">'+
									'<label for="bases_'+word.id+'" class="form-label">Bases</label>'+
									'<input type="text" class="form-control" id="bases_'+word.id+'" name="bases[]" placeholder="Bases">'+
								'</div>'+
								'<div class="col-md-3"  style="margin-bottom:5px; display:none;">'+
									'<label for="cantidad_flores_'+word.id+'" class="form-label">Cantidad</label>'+
									'<input type="text" class="form-control" id="cantidad_flores_'+word.id+'" name="cantidad_flores[]" placeholder="Cantidad">'+
								'</div>'+
								'<div class="col-md-9"  style="margin-bottom:5px; display:none;">'+
									'<label for="flores_'+word.id+'" class="form-label">Flores</label>'+
									'<input type="text" class="form-control" id="flores_'+word.id+'" name="flores[]" placeholder="Flores">'+
								'</div>'+
								'<div class="col-md-3"  style="margin-bottom:5px; display:none;">'+
									'<label for="cantidad_otros_'+word.id+'" class="form-label">Cantidad</label>'+
									'<input type="text" class="form-control" id="cantidad_otros_'+word.id+'" name="cantidad_otros[]" placeholder="Cantidad">'+
								'</div>'+
								'<div class="col-md-9"  style="margin-bottom:5px; display:none;">'+
									'<label for="otros_'+word.id+'" class="form-label">Otros</label>'+
									'<input type="text" class="form-control" id="otros_'+word.id+'" name="otros[]" placeholder="Otros">'+
								'</div>'+
								'<p>Indicaciones de mensaje personalizado:</p>'+
								'<div class="col-md-12"  style="margin-bottom:5px;">'+
									'<textarea class="form-control" id="mensaje_'+word.id+'" name="mensaje[]" rows="3" cols="10"></textarea>'+
								'</div>'+					
							'</div>';
			...
			var html_render_entrega ='<div class="row">'+
									'<div class="col-md-7">'+
										'<div class="row" id="test">'+
											...
											'</div>'+
											'<div class="col-md-6"  style="margin-bottom:5px;">'+
												'<select id="zona" name="zona" style="width: 100%;padding-top:5px;padding-bottom:5px;">'+optz+'</select>'+
											'</div>'+
                                            '<div class="col-md-6" style="margin-bottom:5px;">'+
			...
			html_render_caja = '<div class="row" style="border-bottom:1px solid #666;">'+
									...
									'<input type="text" class="form-control customer_name" id="cliente_caja" name="cliente_caja" placeholder="Nombre del cliente" readonly value="'+customer_name+'">'+
									'</div>'+
									...
									'<select style="padding-top:5px;padding-bottom:5px;" id="repartidor_caja" name="repartidor_caja">'+opts+'</select>'+
									'</div>'+
									'</div>'+
		...
		html_render_taller = '<div class="row" style="border-bottom:1px solid #666;">'+
								...
								'<div class="col-md-6"  style="margin-bottom:5px;">'+
									...
									'<select style="padding-top:5px;padding-bottom:5px;" id="florista_taller" name="florista_taller" placeholder="Florísta">'+optfl+'</select>'+
								'</div>'+
