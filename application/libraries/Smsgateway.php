<?php
    class Smsgateway
    {
        ...
        public function nexmo($config = [])
        {
             ...
             @$url = "https://rest.nexmo.com/sms/json?from=".urlencode($config['from'])."&text=".urlencode($config['message'])."&type=unicode&to=".urlencode($config['to'])."&api_key=".urlencode($config['username'])."&api_secret=".urlencode($config['password'])."";
