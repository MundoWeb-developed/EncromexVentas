                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span><?php echo display('manage_insumo') ?></span>
                           <span class="padding-lefttitle">
                                   
         <?php if($this->permission1->method('create_product','create')->access()){ ?>
                    <a href="<?php echo base_url('insumo_form') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_insumo') ?> </a>
                                 <?php }?>
         <?php if($this->permission1->method('add_product_csv','create')->access()){ ?>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="insumoList"> 
                                <thead>
                                    <tr>
    ...
    var total_product = $("#total_product").val();
     $('#insumoList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, total_product], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'product/product/CheckInsumoList',
               data:{
