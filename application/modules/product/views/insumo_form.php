...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open_multipart('insumo_form/' . $id, array('class' => 'form-vertical', 'id' => 'insert_insumo', 'name' => 'insert_insumo')) ?>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="sell_price" class="col-sm-4 col-form-label">Costo<?php //echo display('sell_price') 
                                                                                            ?> <i class="text-danger">*</i> </label>
                            <div class="col-sm-8">
                                <input class="form-control text-right" id="sell_price_i" name="price" type="text" required="" placeholder="0.00" tabindex="5" min="0" value="<?php echo $product->price ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <table class="table table-bordered table-hover" id="product_table">
                        <thead>
                            <tr>
                                ...
                                <th style="display:none;" class="text-center"><?php echo display('supplier_price') ?> <i class="text-danger">*</i></th>
                            ...
                            <?php if (empty($supplier_pr)) { ?>
                                <tr>
                                    ...
                                    <td class="" style="display:none;">
                                        <input type="text" tabindex="6" class="form-control text-right supplier_price_insumo" name="supplier_price[]" placeholder="0.00" required min="0" />
                                    </td>

                                    <td width="100"> <a id="add_purchase_item" class="btn btn-info btn-sm" name="add-invoice-item" onClick="addinsumo('proudt_item')" tabindex="9"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="submit" id="add-product" class="btn btn-primary btn-large" name="add-product" value="Guardar insumo" tabindex="10" />
                    </div>
                </div>
            </div>
            <?php echo form_close() ?>
