        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('purchase/purchase/bdtask_save_insumo',array('class' => 'form-vertical', 'id' => 'insert_insumo','name' => 'insert_purchase'))?>
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        <td class="span3 supplier">
                                           <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="insumo_pur_or_list(1);" placeholder="<?php echo display('product_name') ?>" id="product_name_1" tabindex="5" >
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td> <button type="button" id="add_invoice_item" class="btn btn-info" name="add-invoice-item"  onClick="addInsumoOrderField1('addPurchaseItem')"  tabindex="9"><i class="fa fa-plus"></i></button>
