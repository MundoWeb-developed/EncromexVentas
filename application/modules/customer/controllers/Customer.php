...
class Customer extends MX_Controller
{
    ...
    public function bdtask_CheckCustomerList2()
    {

        $postData = $this->input->post();
        $data     = $this->customer_model->getCustomerList2($postData);
        echo json_encode($data);
    }
    ...
    public function update_customer_data()
    {
        ...
        $n_nombre_cliente = $this->input->post('n_nombre_cliente', true);
        $telefono_cliente = $this->input->post('telefono_cliente', true);

        $receiptdata = $this->customer_model->update_customer_data($nombre_cliente, $n_nombre_cliente, $telefono_cliente);
    }
}