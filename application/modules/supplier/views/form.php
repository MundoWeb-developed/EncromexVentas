            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                                ...
                                <div class="form-group row"> 
                                    <label style="display:none;" for="fax" class="col-sm-2 text-right col-form-label"><?php echo display('fax')?>:</label>
                                ...
                                <div class="form-group row">
                                    <label style="display:none;" for="state" class="col-sm-2 text-right col-form-label"><?php echo display('state')?>:</label>
                                    <div class="col-sm-4" style="display:none;">
                                        <div class="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="">
                                            ...
                                            <input name="country" type="text" class="form-control " placeholder="<?php echo display('country')?>" value="México<?php //echo $supplier->country?>" id="country" readonly >
                                    ...
                                    <?php if(empty($supplier->supplier_id)){?>
                                     ...
                                     <label style="display:none;" for="previous_balance" class="col-sm-2 text-right col-form-label"><?php echo display('previous_balance')?>:</label>
                                    <div class="col-sm-4" style="display:none;">
                                        <div class="">
