                ...
                <?php }?>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive" >
                            <table class="table table-hover table-bordered" cellspacing="0" width="100%" id="InvList_pc"> 
                                <thead>
                                    <tr>
...
<div class="modal fade" id="modal_pagado" role="dialog">	
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="newform">
					Cambiar a pagado:
					<select style="padding:6px;" id="tipo_pago_mover">
						<option value="Efectivo">Efectivo</option>
						<option value="Tarjeta">Tarjeta</option>						
						<option value="Transferencia">Transferencia</option>
					</select>
					<input type="hidden" id="invoice_id_mover">
					<input type="button" id="mover_a_pagado" class="btn btn-success mr-2" value="Guardar">
				</div>
			</div>
		</div>
	</div>
