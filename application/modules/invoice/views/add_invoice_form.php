                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" size="100"  name="customer_name" class=" form-control" placeholder='<?php echo display('customer_name').'/'.display('phone') ?>' id="customer_name" tabindex="1" onkeyup="customer_autocomplete()" value="Venta en general<?php //echo $customer_name?>"/>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo display('item_description')?></th>
                                         <th style="display: none;" class="text-center"><?php echo display('serial_no')?></th>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td style="display: none;" class="invoice_fields">
