		   ...
		   <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 col-p-2" style="padding-right: 5px;padding-left: 5px;">
			   ...
			   <div class="product-panel overflow-hidden border-0 shadow-sm">
				   ...
				   <div class="panel-footer border-0 bg-white">
					   <h3 class="item-details-title text-center">Arreglo personalizado</h3>
				   </div>
			   </div>
			   </a>
			</div>
...
<div class="col-sm-12 col-md-12">
 ...
 <?php echo form_open_multipart('invoice/invoice/bdtask_manual_sales_update', array('class' => 'form-vertical', 'id' => 'gui_sale_update', 'name' => 'update_pos_invoice')) ?>	
	...
	<input class="form-control" type="hidden"  name="edit_invoice_id" id="edit_invoice_id" value="<?php echo $invoice_data->invoice_id; ?>" readonly/>
	...
	<input type="text" class="form-control customerSelection" id="customer_name" value="Venta en general<?php //echo $customer_name;?>" tabindex="3"  onkeyup="customer_autocomplete()"  name="customer_name">	
	<?php
	$opts = '';
	if($deliveryman){
	...
	<div class="row mb-3 mt-3" style="margin-top:20px;">			
			...
			<div class="col-md-2 col-12">			
				<div class="form-check">
				  <input class="form-check-input" value="MSN" type="radio" name="tipo_venta" id="opt3" >
			...
			<div class="col-md-2 col-12">			
				<div class="form-check">
				  <input class="form-check-input" value="Instagram" type="radio" name="tipo_venta" id="opt4" >
...
name="shipping_cost" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" placeholder="0.00" value="<?php echo $invoice_data->shipping_cost;?>"/>
...
<input type="text" class="form-control" id="paidAmount"  onkeyup="invoice_paidamount()" name="paid_amount" onkeypress="invoice_paidamount()" placeholder="0.00" value="<?php echo $invoice_data->paid_amount;?>">
</div>
</div>
...
<div class="cal-box d-lg-flex align-items-lg-center mr-4">
	<div class="form-inline d-inline-flex align-items-center">
		...
		<select style="padding:8px;" id="tipo_pago" name="tipo_pago">
			...
			<option value="Por cobrar">Credito Interno</option>
...
<div class="">
	...
	<div class="form-check">
		<input class="form-check-input" type="checkbox" id="instore" name="instore">
	...
	<div class="row">
		<div class="col-md-7">	
			<div class="row" id="test">	
				...
				<div class="col-md-4" style="margin-bottom:5px;">
					<select id="zona" name="zona" style="padding-top:5px;padding-bottom:5px;">
					<?php if($zonas){ ?>
						<?php foreach($zonas as $zn){ ?>
							<option value="<?php echo $zn->id; ?>" ><?php echo $zn->zona; ?></option>
						<?php } ?>
					<?php }else{ ?>
		...
		<div class="col-md-5 instore">
			<div id="us1" style="width:100%; height:220px;"></div>
		</div>
		<script>	 
			 $('#us1').locationpicker({
				 location: {
...
<div class="mb-5 instore">
	<h3 style="background:white; padding:5px; color:black">REPARTO</h3>
<hr>
	
<div id="render_reparto">	
<div class="row" style="border-bottom:1px solid #666;">	
	...
	<div class="col-md-3" style="margin-bottom:5px;">
		...
		<input type="text" class="form-control" id="fecha_entrega_reparto" name="fecha_entrega_reparto" placeholder="Fecha de entrega" value="<?php echo date('Y-m-d');?>" readonly>
	</div>
	...
	<div class="col-md-6" style="margin-bottom:5px;">
		<label for="descripción_entrega_reparto" class="form-label">Anotaciones de entrega/Referencias</label>
		<input type="text" class="form-control" id="descripción_entrega_reparto" name="descripcion_entrega_reparto" placeholder="Anotaciones de entrega/Referencias" readonly>
	</div>
...
<div class="mb-5">
	<h3 style="background:white; padding:5px; color:black">CAJA</h3>
	<hr>
...
<div class="row" style="border-bottom:1px solid #666;">		
	<div class="col-md-6"  style="margin-bottom:5px;">
		...
		<input type="text" class="form-control customer_name" id="cliente_caja" name="cliente_caja" placeholder="Nombre del cliente" readonly>
	</div>	
	...
	<div class="col-md-3" style="margin-bottom:5px;">
		...
		<input type="text" class="form-control" id="fecha_entrega_caja" name="fecha_entrega_caja" placeholder="Fecha de entrega" readonly value="<?php echo date('Y-m-d');?>">
	</div>	
	...
	<div class="col-md-6" style="margin-bottom:5px;">
		<label for="descripción_entrega_caja" class="form-label">Anotaciones de entrega/Referencias</label>
		<input type="text" class="form-control" id="descripción_entrega_caja" name="descripcion_entrega_caja" placeholder="Anotaciones de entrega/Referencias" readonly>
	</div>
	
	<div class="col-md-6" style="margin-bottom:5px;">
		<label for="repartidor_caja" class="form-label">Repartidor:</label>
		<!--<input type="text" class="form-control" id="repartidor_caja" name="repartidor_caja" placeholder="Repartidor">-->
		<select class="form-control" id="repartidor_caja" name="repartidor_caja">
		<?php if($deliveryman){ ?>
...
<div class="mb-5">
	<h3 style="background:white; padding:5px; color:black">TALLER</h3>
	<hr>
	<div id="render_taller">	
<div class="row" style="border-bottom:1px solid #666;">	
	...
	<div class="col-md-3 instore" style="margin-bottom:5px;">
		...
		<input type="text" class="form-control" id="fecha_entrega_taller" name="fecha_entrega_taller" placeholder="Fecha de entrega"  readonly  value="<?php echo date('Y-m-d');?>">
	</div>	
	...
	<div class="col-md-6"  style="margin-bottom:5px;">
		<label for="florista_taller" class="form-label">Florísta</label>
		<!--<input type="text" class="form-control" id="florista_taller" name="florista_taller" placeholder="Florísta">-->
		
		<select class="form-control" id="florista_taller" name="florista_taller">
		<?php if($florist){ ?>
...
<div class="mb-5">
	<h3 style="background:white; padding:5px; color:black">Cancelación</h3>
	<hr>
	<div class="form-check">
	...
	<div id="motivo_cancelacion" style="display:none;">
		<p>Motivos de cancelación:</p>
		<div class="col-md-12"  style="margin-bottom:5px;">		
			<textarea class="form-control" id="motivo" name="motivo" rows="3" cols="10"></textarea>
			<br>
			<br>
			<br>
		</div>
...
<div class="tab-pane fade" id="arr_personalizado">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<input type="hidden" id="count_ip" value='<?php if(empty($insumos_pr)){echo 0;}else{echo (int)count($insumos_pr); } ?>' name="">
			...
			<input type="hidden" id="insumo_list" value='<?php if ($insumos) { ?><?php foreach($insumos as $insumo){?><option value="<?php echo $insumo['id']?>"><?php echo $insumo['product_name']?> (<?php echo $insumo['product_model']?>)</option><?php }}?>' name="">			
...
<script>
	...
	console.log(arrp);
	if(arrp!=''){
		setTimeout(function() { onselectimage(arrp); }, 1000);		
	}
	...
	$("input[name=tipo_venta][value=<?php echo $invoice_data->tipo_venta; ?>]").attr('checked', 'checked');
...
<?php 
	...
	<script>		 
		setTimeout(function() { onselectimage("<?php echo $detail['product_id']; ?>"); }, 500);
	</script>
	<?php
	}
	...
	foreach ($invoice_details as $detail) { ?>
	<script>		 
		setTimeout(function() { $('#total_qntt_<?php echo $detail['product_id']; ?>').val("<?php echo $detail['quantity']; ?>"); 
							  
							  quantity_calculate(<?php echo $detail['product_id']; ?>);
							  }, 500);
	</script>
	<?php
	}
...
<?php 
$delim = $invoice_data->delivery_multiple;
$instore = $invoice_data->instore;

$cancelado = $invoice_data->cancelado;
...
if($cancelado=='1'){	
	...
	<script>
		setTimeout(function() {
			...
			$("#cancel").click();
			$('#motivo').val("<?php echo $invoice_data->motivo_cancelacion; ?>");
...
if($delim=='1'){	
	...
	<script>
		setTimeout(function() {			
			$("#instore").click();
			$('#dh_instore').val("<?php echo date('Y-m-d', strtotime($invoice_data->fecha_entrega)); ?> <?php echo $invoice_data->hora_entrega; ?>");
		}, 1000);
	...
	<script>
		setTimeout(function() {
			...
			$('#tipo_pago').val("<?php echo $invoice_data->tipo_pago; ?>");	
			
			jQuery(document).ready(function($) {
				$('#boff').val('<?php echo $invoice_data->branchoffice; ?>');
			});
			
			$('#destinatario').val("<?php echo $invoice_data->destinatario; ?>");
			$('#fecha_entrega').val("<?php echo date('Y-m-d', strtotime($invoice_data->fecha_entrega)); ?>");
			$('#hora_entrega').val("<?php echo $invoice_data->hora_entrega; ?>");
			$('#direccion').val("<?php echo $invoice_data->direccion; ?>");
			$('#direccion2').val("<?php echo $invoice_data->direccion2; ?>");
			$('#zona').val("<?php echo $invoice_data->zona; ?>");
			$('#descripcion_entrega').val("<?php echo $invoice_data->descripcion_entrega; ?>");
			$('#telefono').val("<?php echo $invoice_data->telefono; ?>");
			$('#nombre_cliente').val("<?php echo $invoice_data->nombre_cliente; ?>");
			$('#telefono_cliente').val("<?php echo $invoice_data->telefono_cliente; ?>");
			$('#florista_taller').val("<?php echo $invoice_data->florista_taller; ?>");
			$('#repartidor_caja').val("<?php echo $invoice_data->repartidor_caja; ?>");
			$('#mensaje').val("<?php echo $invoice_data->mensaje; ?>");	
			
			$('#destinatario_reparto').val("<?php echo $invoice_data->destinatario; ?>");
			$('#fecha_entrega_reparto').val("<?php echo date('Y-m-d', strtotime($invoice_data->fecha_entrega)); ?>");
			$('#hora_entrega_reparto').val("<?php echo $invoice_data->hora_entrega; ?>");
			$('#direccion_reparto').val("<?php echo $invoice_data->direccion; ?>");
			$('#descripcion_entrega_reparto').val("<?php echo $invoice_data->descripcion_entrega; ?>");
				
			$('#cliente_caja').val("<?php echo $invoice_data->nombre_cliente; ?>");
			$('#fecha_entrega_caja').val("<?php echo date('Y-m-d', strtotime($invoice_data->fecha_entrega)); ?>");
			$('#hora_entrega_caja').val("<?php echo $invoice_data->hora_entrega; ?>");
			$('#destinatario_caja').val("<?php echo $invoice_data->destinatario; ?>");
			$('#direccion_caja').val("<?php echo $invoice_data->direccion; ?>");
			$('#descripcion_entrega_caja').val("<?php echo $invoice_data->descripcion_entrega; ?>");
				
			$('#fecha_entrega_taller').val("<?php echo date('Y-m-d', strtotime($invoice_data->fecha_entrega)); ?>");
			$('#hora_entrega_taller').val("<?php echo $invoice_data->hora_entrega; ?>");
