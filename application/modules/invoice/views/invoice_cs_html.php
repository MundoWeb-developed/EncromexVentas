                                ...
                                <div class="col-sm-4 text-left invoice-address">
									...
									<?php if($delivery_multiple=='1'){
												...
												foreach ($data_reparto as $reparto){ ?>
													...
													<address class="margin-top10">										
														<abbr><b>Nombre del cliente:</b></abbr> <?php echo $reparto['nombre_cliente'];?><br>
									...
									<address class="margin-top10">										
                                        <abbr><b>Nombre del cliente:</b></abbr> <?php echo $nombre_cliente;?><br>
                                        <abbr><b>Teléfono del cliente:</b></abbr> <?php echo $telefono_cliente;?><br>
...
<?php }?>
							...
							<div class="row margin-top50">
                                <div class="col-sm-12">
									<p>Este no es un comprobante fiscal, si requiere factura por favor solicítela al  951... el mismo día de su compra.</p>
                                </div>                               
                            </div>
